...
def DataAnalyzer():
    ...
    depressive_predictor_prep = \
        DataController.prep_dataset_for_depressive_predictor(depressive_predictor_data)
    ...
    type_2_diabetes_predictor_svm = DataController.Create_ComplementNB_Model(type_2_diabetes_predictor_prep)

    # prep the data for the forest model to predict heart disease
    heart_disease_predictor_data = df.copy()
    heart_disease_predictor_prep = \
        DataController.prep_dataset_for_heart_disease_predictor(heart_disease_predictor_data)
